...
| [WHITESPACE](src/test/resources/etc/data/wr/iris_wr_report.WHITESPACE.csv.gz) | 600698 | As opposed to UNWISE_CHARACTER, the tendency is for IRIs to be resolvable (if properly escaped), and not be the result of an error. | flag as warning | Escape violating characters |
